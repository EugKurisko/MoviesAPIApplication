<nav class="bg-indigo-900 flex text-white font-bold py-4">
    <div class="container mx-auto flex items-center justify-between">
        <ul class="flex items-center justify-between white">
            <li class="ml-16">
                <a href="/moviesp">
            ...
            <li class="ml-16" id="zone-movies">
                <div class="relative inline-block text-left">
                    <div id="drop-movies">
                        <a href="/moviesp" class="inline-flex justify-center w-fer-graull shadow-sm px-4 py-2 text-sm font-medium" id="menu-movies" aria-expanded="true" aria-haspopup="true">
                            Movies
                        </a>
                    </div>
                </div>
        ...
        <div class="flex items-center">
            <div class="relative">
                <input type="text" name="search" placeholder="Search"
                 class="bg-gray-800 rounded-full w-64 px-6 py-1 focus:outline-none">
            </div>
        </div>
    </div>
</nav>